---
title: Logic and Set exercise
draft: false
date: 2025-10-04 21:41:44 +0700
tags:
  - comsci
description: Short summary of the post.
---
# 🧩 Set Theory & Logic Practice Lad
Contentder
...
1. $x \in A \cap B \Leftrightarrow (x \in A) \land (x \in B)$  
2. $x \in A \cup B \Leftrightarrow (x \in A) \lor (x \in B)$  
3. $x \in A - B \Leftrightarrow (x \in A) \land \neg(x \in B)$  
4. $x \in A' \Leftrightarrow \neg(x \in A)$  
5. $A \subseteq B \Leftrightarrow \forall x,\ (x \in A \Rightarrow x \in B)$  
6. $A = B \Leftrightarrow (A \subseteq B) \land (B \subseteq A)$  
